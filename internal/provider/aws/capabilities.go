...
func Capabilities() []resource.CapabilityDef {
	return []resource.CapabilityDef{
		...
		{
			Name: manifest.CapabilitySecrets,
			Summary: "SSM Parameter Store SecureString parameters, one per named entry, " +
				"generated by kraai or set by the operator; the value is never desired state.",
			Binding:          secretsBindingSchema,
			ProviderSettings: regionSettingsSchema,
		},
	}
}
